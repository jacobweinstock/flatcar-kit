// Package build derives a human-readable version string for the binary from the
// Go module pseudo-version that the toolchain stamps into it from VCS
// information.
package build
...
// Version formats a Go module pseudo-version into a base semantic version
// followed by a short commit hash (for example "v0.24.1-718c98b9"). Inputs that
// are not recognized pseudo-versions are returned unchanged.
